...
public class pendingItemsAdapter extends FirebaseRecyclerAdapter<Item, pendingItemsAdapter.itemsViewHolder> {
    /**
    ...
    public pendingItemsAdapter(@NonNull FirebaseRecyclerOptions<Item> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull pendingItemsAdapter.itemsViewHolder holder, int position, @NonNull Item model) {
    ...
    @NonNull
    @Override
    public pendingItemsAdapter.itemsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_my_item,parent,false);
        return new pendingItemsAdapter.itemsViewHolder(view);
    }
